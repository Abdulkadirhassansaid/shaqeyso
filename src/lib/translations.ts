...
export const translations = {
    en: {
        ...
        withdrawalInitiatedDesc: (amount: number) => `Your withdrawal of $${amount.toFixed(2)} has been initiated and is now pending.`,
    ...
    so: {
        ...
        withdrawalInitiatedDesc: (amount: number) => `Kula bixidaada $${amount.toFixed(2)} waa la bilaabay oo hadda way sugaysaa.`,
